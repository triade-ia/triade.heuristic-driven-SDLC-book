...
4. **Crie relatório estruturado** e salve em `output/test/test-strategy-[nome-funcao]-[YYYYMMDD].md`
5. **Recomende próximos passos** (qual guide consultar e como passar o relatório)

**IMPORTANTE**: Ao finalizar a análise, SEMPRE gerar o arquivo de relatório em `output/test/` para que o desenvolvedor possa usá-lo como contexto ao chamar os guides.
...
**Caminho**: `output/test/test-strategy-[nome-funcao]-[YYYYMMDD].md`

**Exemplo de nome**: `output/test/test-strategy-validateAmount-20260217.md`
...
Exemplo: `@TEST_UNIT_GUIDE.md @output/test/test-strategy-[este-arquivo].md`
...
1. Salve o relatório em `output/test` (a skill deve tê-lo gerado)
2. Chame o guide com o relatório: `@TEST_UNIT_GUIDE.md @output/test/test-strategy-validateAmount-20260217.md`
